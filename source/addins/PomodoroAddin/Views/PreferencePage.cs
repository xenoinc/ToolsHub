...
namespace PomodoroAddin.Views
{
  public partial class PreferencePage : Form, IPreferencePageForm
  {
    ...
    public bool OnSave()
    {
      ...
      SettingsService.SetValue(Constants.AddinId, Constants.FlashScreenEvents, ChkFlashScreenEvents.Checked.ToString());
      SettingsService.SetValue(Constants.AddinId, Constants.SysTrayBubbles, ChkSysTrayBubbles.Checked.ToString());
      SettingsService.SetValue(Constants.AddinId, Constants.SysTrayDurations, ChkSysTrayDurations.Checked.ToString());
    ...
    {
      TxtDuration.Text = _manager.TimerDuration.ToString();
      TxtBreakShort.Text = _manager.TimerShortBreak.ToString();
      TxtBreakLong.Text = _manager.TimerLongBreak.ToString();

      ChkFlashScreenEvents.Checked = _manager.DoesFlashScreenEvents;
      ChkSysTrayBubbles.Checked = _manager.DoesSysTrayBubbles;
      ChkSysTrayDurations.Checked = _manager.DoesSysTrayIconUpdates;
    }
  }
}
